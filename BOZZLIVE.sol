/** DEPLOY as BOZZCOIN -Contracts/BOZZLive.sol
...
contract MyContract2 {
    // Define your BEP20 token contract here
    IBEP20 public bep20Token;

    constructor(IBEP20 _bep20Token) {
        bep20Token = _bep20Token;
    }

    function getAirdrop() public {
        require(bep20Token.balanceOf(msg.sender) > 0, "Sender does not hold the coin");
        bep20Token.transfer(msg.sender, 100);
    }
}
...
contract DividendDistributor is IDividendDistributor {
  ...
  IBEP20 RWRD = IBEP20(0x4174E357B290c3a1894A4535dc14eF5BDD26f8ae); //distribution
...
contract BOZZCoin is IBEP20, Auth {
  using SafeMath for uint256;
  ...
  string constant _name = "BOZZCoin";
  string constant _symbol = "BOZZ";
  ...
  uint256 public sellMultiplier = 101;
  ...
  //bool public tradingOpen = true;  --suspend trading function
  bool public rebaseStatus = true;
...
// Coin Supply 
 ...
 // uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 10**9 * 10**_decimals;
  uint256 public swapThreshold = (rSupply * 2) / 10000;
  ...
  constructor() Auth(msg.sender) {
   ...
   // autoLiquidityReceiver = 0x45633590b78CE6026A336D0b041eeD2B93cD68Cf;  //MAIN ACCOUNT
  //  marketingFeeReceiver = 0x9f64Bc49405bD3Cf96C83ADFF21Ec7112E62D81b;  // Reflections Account
   // devFeeReceiver = 0x9f64Bc49405bD3Cf96C83ADFF21Ec7112E62D81b;        // Reflections Account
